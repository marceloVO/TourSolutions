...
{
    const  REGISTRO_EXITOSO = 'Se ha registrado exitosamente';//mensaje estatico
     ...
     */
    private $password;
    /*relacion de usuarios con Galeria de uno a muchos */
    /*
     *@ORM\OneToMany(targetEntity="App\Entity\Galeria", mappedBy="user")   
    */
    private $galeria;
